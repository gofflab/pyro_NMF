...
data = ad.read_h5ad('/raid/kyla/projects/pyro_NMF/analyses/ryan_tau/hippo_2956_neurons.h5ad') # samples x genes
...
savename = 'neurons_n15' # output anndata will be saved in outputDir/savename.h5ad
