...
counts = data.X
learned_patterns = ad.read_h5ad('/raid/kyla/projects/pyro_NMF/analyses/ryan_tau/hippo_n15_fixTauIntensity_ints.h5ad')
fixed_geneWeights = learned_patterns.varm['best_A'].loc[list(data.var.loc[:,'gene_name']),['tau_intensity']]


#%%
D = torch.tensor(counts) ## RAW COUNT DATA
...
num_steps = 20000 # Define the number of optimization steps
...
savename = 'OteroMerGenes_fixTauInts_n10_20k' # output anndata will be saved in outputDir/savename.h5ad
