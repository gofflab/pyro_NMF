...
#fixed_geneWeights = learned_patterns.varm['best_A'].loc[:,['layer 1', 'layer 2/3', 'layer 4', 'layer 5', 'layer 6', 'SS', 'MO']]
...
#### output parameters
outputDir = '/raid/kyla/projects/pyro_NMF/analyses/fixLayersAreas'
savename = 'fixGenesAvgExp' # output anndata will be saved in outputDir/savename.h5ad
