...
data = ad.read_h5ad('/raid/kyla/projects/pyro_NMF/analyses/Otero_tau/excitatory_HVG5k.h5ad') # samples x genes
counts = data.raw.X
#%%
...
savename = 'excitatory_n10_SStau' # output anndata will be saved in outputDir/savename.h5ad
