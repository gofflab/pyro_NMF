...
data = data[data.obs['brain_section_num'].apply(lambda x: x >= 1.053 and x <= 1.063)]   # .apply(lambda x: x >= 1.043 and x <= 1.090)]
...
num_patterns = 30 # select num patterns
...
savename = 'z15_slices' # output anndata will be saved in outputDir/savename.h5ad
