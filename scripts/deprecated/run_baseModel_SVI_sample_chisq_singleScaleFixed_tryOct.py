...
S125 = ad.read_h5ad('/mnt/morbo/Users/kwoyshner/octopus/data/fixed/20240311_S135inner_transverse_pearson_residual_in_tissue.h5ad')
...
#### output parameters
outputDir = '/home/kyla/projects/pyro_NMF/results/octopus_test'
savename = 'S125_scale10' # output anndata will be saved in outputDir/savename.h5ad

useTensorboard = True
tensorboard_identifier = 'S125_scale10' # key added to tensorboard output name
...
model = Gamma_NegBinomial_base(D.shape[0], D.shape[1], num_patterns, scale=scale, use_chisq=use_chisq, NB_probs = NB_probs, device=device)          
