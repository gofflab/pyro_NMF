...
from pyroNMF.models.gamma_NB_base_multiScaleUpdate import Gamma_NegBinomial_base
import random
...
savename = 'test_mem' # output anndata will be saved in outputDir/savename.h5ad

useTensorboard = True
tensorboard_identifier = 'test_mem' # key added to tensorboard output name
...
result_anndata.obsm['scale_P'] = loc_P
...
scale_A.index = result_anndata.var.index
