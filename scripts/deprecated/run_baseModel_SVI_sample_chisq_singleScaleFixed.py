...
savename = 'test_singleScaleFixed_s100' # output anndata will be saved in outputDir/savename.h5ad

useTensorboard = True
tensorboard_identifier = 'test_singleScaleFixed_s100' # key added to tensorboard output name
