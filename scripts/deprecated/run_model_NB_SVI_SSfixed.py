...
from models.model_NB_cleaned_SS import SSGammaMatrixFactorization, plot_grid, plot_correlations
...
model = SSGammaMatrixFactorization(D.shape[1], D.shape[0], num_patterns, fixed_patterns=transformed_matrix.to_numpy(), NB_probs = NB_probs, device=device)
