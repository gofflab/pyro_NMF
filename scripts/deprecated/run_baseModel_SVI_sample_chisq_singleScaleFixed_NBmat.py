...
from pyroNMF.models.gamma_NB_base_singleScaleFixed_NBmat import Gamma_NegBinomial_base
import random
...
#### output parameters
outputDir = '/home/kyla/projects/pyro_NMF/results/NBmat'
savename = 'uncertainty_scale1_chisq_run3' # output anndata will be saved in outputDir/savename.h5ad

useTensorboard = True
tensorboard_identifier = 'uncertainty_scale1_chisq_run3' # key added to tensorboard output name
