...
#### input data here, should be stored in anndata.X layer
data = ad.read_h5ad('/raid/kyla/projects/pyro_NMF/analyses/ryan_tau/hippo_2956_tau.h5ad') # samples x genes
data = data[:,data.var.index != 'NAT8B']
...
#%%
fixAT8 = ad.read_h5ad('/raid/kyla/projects/pyro_NMF/analyses/Otero_tau/excitatory_subsetMerGenes_fixAT8.h5ad')
fixAT8_pat = fixAT8.varm['best_A'].loc[:,['AT8']].set_index(fixAT8.var.loc[:,'gene_name'])
fixed_patterns = torch.tensor(fixAT8_pat.loc[data.var.index,:].to_numpy())
...
#### output parameters
outputDir = '/raid/kyla/projects/pyro_NMF/analyses/ryan_tau'
savename = 'hippo_n15_fixAT8otero'
