...
#layers = data.obsm['atlas'].loc[:,['layer 1','layer 2/3','layer 4','layer 5', 'layer 6', 'SS', 'MO']]*1
...
fixed_pattern_names = list(layers.columns)
...
savename = 'fix_areasOnly' # output anndata will be saved in outputDir/savename.h5ad
