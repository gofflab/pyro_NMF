...
#%%
D = torch.tensor(data.layers['counts']) ## RAW COUNT DATA
...
num_patterns = 4 # select num patterns
...
#### output parameters
outputDir = '/raid/kyla/projects/pyro_NMF/analyses/nsf_spatialSimulated'
savename = 'sim_n4_wChisq_run5' # output anndata will be saved in outputDir/savename.h5ad
...
if spatial:
    ...
    plot_dims = [2, 2] # rows x columns should be > num patterns; this is for plotting
