...
from pyro_NMF.models.gamma_NB_base import Gamma_NegBinomial_base
...
savename = 'test' # output anndata will be saved in outputDir/savename.h5ad

useTensorboard = True
tensorboard_identifier = 'test' # key added to tensorboard output name
