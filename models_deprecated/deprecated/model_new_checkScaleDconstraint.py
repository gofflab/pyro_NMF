...
class GammaMatrixFactorization(PyroModule):
    def __init__(self,
        ...
        self.scale_D = PyroParam(torch.ones(self.num_samples, self.num_genes, device=self.device), constraint=dist.constraints.interval(0.1, scaleD_con)) # KW TODO: how to determine constraints? rn hardcoded as max SD of a gene from input data
