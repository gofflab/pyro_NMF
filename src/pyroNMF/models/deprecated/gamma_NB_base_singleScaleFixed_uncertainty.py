"""Deprecated Gamma-NB model with uncertainty scaling (kept for reference)."""
#%%
import pyro
...
class Gamma_NegBinomial_base(PyroModule):
    """Deprecated Gamma-Negative Binomial model using uncertainty weights."""
    def __init__(self,
                num_samples,
                num_genes,
                num_patterns,
        ...
        uncertainty : torch.Tensor or float
            Per-entry uncertainty used in chi-squared computation.
