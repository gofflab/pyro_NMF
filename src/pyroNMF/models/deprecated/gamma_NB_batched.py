"""Deprecated batched Gamma-NB model (kept for reference)."""
#%%
import pyro
...
class Gamma_NegBinomial_batched(Gamma_NegBinomial_base):
    """Deprecated batched Gamma-Negative Binomial model."""
    def __init__(self,
                 num_genes,
                 num_samples,
                 num_patterns,
        ...
        """Initialize the deprecated batched model.
